...
/**
 * Level 2. Split out of app/category/[slug]/page.tsx so that the route file can
 * be a server component and declare its params at build time — a "use client"
 * page cannot export generateStaticParams, and without it Next.js treats the
 * segment as dynamic and provisions a server render for a page whose data is
 * entirely compiled in.
 */
